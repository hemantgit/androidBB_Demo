...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaultHooks = __webpack_require__(31);
	 ...
	 * Changelog
	 */
	var moduleKey = 'widget-demo-changelog-ng';
	var hooksKey = moduleKey + ':hooks';
	
	exports.default = _vendorBbAngular2.default.module(moduleKey, [_libBbWidgetNg2.default, _libBbEventBusNg2.default]).factory(hooksKey, (0, _libBbWidgetExtensionNg2.default)(_defaultHooks2.default)).controller('ChangelogController', [
...
/***/ function(module, exports) {
	...
	function ChangelogController(bus, hooks, widget, $http) {
	  var $ctrl = this;
	  var storage = cxp.mobile.plugins.InMemoryStorage;
	  ...
	  var versionClicked = function versionClicked(versionIndex) {
...
;
//# sourceMappingURL=widget-demo-changelog-ng.js.map