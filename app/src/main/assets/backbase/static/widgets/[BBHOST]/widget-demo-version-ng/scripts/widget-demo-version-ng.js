(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("widget-demo-version-ng", ["vendor-bb-angular", "lib-bb-widget-ng", "lib-bb-event-bus-ng", "lib-bb-widget-extension-ng"], factory);
	else if(typeof exports === 'object')
		exports["widget-demo-version-ng"] = factory(require("vendor-bb-angular"), require("lib-bb-widget-ng"), require("lib-bb-event-bus-ng"), require("lib-bb-widget-extension-ng"));
	else
		root["widget-demo-version-ng"] = factory(root["vendor-bb-angular"], root["lib-bb-widget-ng"], root["lib-bb-event-bus-ng"], root["lib-bb-widget-extension-ng"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaultHooks = __webpack_require__(40);
	 ...
	 * Version
	 */
	var moduleKey = 'widget-demo-version-ng';
	var hooksKey = moduleKey + ':hooks';
	
	exports.default = _vendorBbAngular2.default.module(moduleKey, [_libBbWidgetNg2.default, _libBbEventBusNg2.default]).factory(hooksKey, (0, _libBbWidgetExtensionNg2.default)(_defaultHooks2.default)).controller('VersionController', [
...
/***/ function(module, exports) {
	...
	function VersionController(bus, hooks, widget) {
	  var $ctrl = this;
	  ...
	  var $onInit = function $onInit() {
	    bus.subscribe('versionClicked', function (payload) {
...
;
//# sourceMappingURL=widget-demo-version-ng.js.map